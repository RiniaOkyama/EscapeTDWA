    ...
    const tl = [
        {
            ...
            text: "RT @TwitterDev: 1/ Today we're sharing our vision for the future of the Twitter API platform! https://t.co/XweGngmxlP",
            truncated: false,
            entities: {
                hashtags: [],
                symbols: [],
        ...
        },
        {
            ...
            text: "RT @TwitterMktg: Starting today, businesses can request and share locations when engaging with people in Direct Messages. https://t.co/rpYndqWfQw",
            truncated: false,
            entities: {
                hashtags: [],
                symbols: [],
                    ...
                    urls: [
                        {
                            ...
                            expanded_url:
                                "https://cards.twitter.com/cards/5wzucr/3x700",
                            display_url:
                                "cards.twitter.com/cards/5wzucr/3…",
                            indices: [105, 128],
                        },
                    ],
                },
